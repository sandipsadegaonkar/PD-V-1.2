<html>
    <head>
        ...
        <script type="text/javascript" src="../javascript/system_user.js"></script>
        <link href="../css/foundation-icons.css" rel="stylesheet" type="text/css"/>
    </head>
    <body>        
    <div>
     <div class="medium radius button callout" id='add_system_user' >
         [<span class="systemuser_close">+</span>]Add System User
    </div>
    <br>
      <div class="panel hide small-9" id="system_user_page">
         <i class="fi-clipboard-pencil" style="font-size:30px"></i> <b><h> Add System User information:</h></b>
        <hr>          
         <form data-abide id='add_System_user_form'>   
          <div class="large-12 row collapse">
                <div class='small-4 columns left'>
                    <label class="postfix">First Name</label>
                </div>  
                <div class="small-8 columns right"> 
                     <input type="text" name="add_sys_user_firstname">
                </div>
          </div>
          <div class="large-12 row collapse">
               <div class='small-4 columns left'>
              ...
              <div class="small-8 columns right"> 
                     <input type="text" name="add_sys_user_lastname">
                </div>                          
          </div>
          <div class="large-12 row collapse">
...
<div class="large-12 row collapse">
                <div class="small-8 columns"> 
                     <input type="text" name="add_sys_username">
                </div>
                <div class='small-4 columns'>
         ...
         <input type="submit" value="Save changes" class='medium radius button' id="reset__sys_user_button">            
         <input type="reset" value="reset"  class='medium radius button' id="add_sys_user_button">                
               ...
               <div class="columns left">
                   <div class="callout">
                       <div class="small-3">
                           ...
                           <div style=" width: 150px; margin-left: 40px; font-size: 20px; margin-top: -2rem;">System User</div>
                       </div>
                   </div>        
